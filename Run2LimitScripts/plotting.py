...
def StyleLimitBand(graph_dict, overwrite_style_dict=None):
    style_dict = {
            ...
            'exp1' : { 'FillColor' : R.TColor.GetColor("#85D1FBff")}, #'exp1' : { 'FillColor' : R.kGreen}
            'exp2' : { 'FillColor' : R.TColor.GetColor("#FFDF7Fff")} #'exp2' : { 'FillColor' : R.kYellow}
            }
